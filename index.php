 ...
 * Plugin URI: https://github.com/ramon94/WooCommerce-PostaPont
 * Description: PostaPont integráció WooCommerce-hez.
 * Version: 1.1
 * Author: ramon94 | Original author: Peter Viszt
 * Author URI: https://github.com/ramon94/WooCommerce-PostaPont
 */
...
class WC_PostaPont {
    ...
    public function __construct() {
		...
		//Default variables
		self::$plugin_prefix = 'WooCommerce-PostaPont_';
	...
	public function frontend_css_js() {
		...
		if(get_the_ID () == get_option ( 'woocommerce_checkout_page_id' , 0 )) {
			...
			wp_enqueue_style( 'PostaPont CSS', 'https://www.posta.hu/static/internet/app/postapont/css/postapont-api.css' );
			wp_enqueue_script( 'PostaPont API', 'https://www.posta.hu/static/internet/app/postapont/javascripts/postapont-api.js', null, null, true );
			wp_register_script( 'wc-postapont-js', wc_postapont::$plugin_url.'postapont.js', null,'1.2', true);
			

			$categories = array('10_posta','20_molkut','30_csomagautomata');
			$posta_pont_options['disabled_categories'] = array();
